...
from sfeir.hivemind.protos import (
    hivemind_pb2 as sfeir_dot_hivemind_dot_protos_dot_hivemind__pb2,
)
...
def add_GreeterServicer_to_server(servicer, server):
    rpc_method_handlers = {
        "SayHello": grpc.unary_unary_rpc_method_handler(
            servicer.SayHello,
            request_deserializer=sfeir_dot_hivemind_dot_protos_dot_hivemind__pb2.HelloRequest.FromString,
            response_serializer=sfeir_dot_hivemind_dot_protos_dot_hivemind__pb2.HelloReply.SerializeToString,
        ),
    }
